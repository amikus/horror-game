...
-----|-------------|---------------|-------------|--------|------------
Win conditions | x |  | ~~Add logic to level 1 for win condition~~ | 1 | X 
...
Monsters | x | x | ~~Research AI~~ | 40 | X
 ...
 | x | x | ~~Add ability to damage player~~ | 3 | X
 | x | x | ~~Implement AI for each monster type~~ | 100 | X
